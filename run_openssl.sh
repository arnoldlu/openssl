...
#make && ./apps/openssl s_client -connect 221.176.66.230:20001 -proxy proxynj.zte.com.cn:80
#make && ./apps/openssl s_client -connect b.fxltsbl.com:443 -proxy proxynj.zte.com.cn:80
#sudo make install
